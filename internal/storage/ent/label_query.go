...
func (_q *LabelQuery) QueryResource() *ResourceQuery {
...
func (_q *LabelQuery) FirstID(ctx context.Context) (id int, err error) {
	var ids []int
...
func (_q *LabelQuery) FirstIDX(ctx context.Context) int {
...
func (_q *LabelQuery) OnlyID(ctx context.Context) (id int, err error) {
	var ids []int
...
func (_q *LabelQuery) OnlyIDX(ctx context.Context) int {
...
func (_q *LabelQuery) IDs(ctx context.Context) (ids []int, err error) {
...
func (_q *LabelQuery) IDsX(ctx context.Context) []int {
	ids, err := _q.IDs(ctx)
	if err != nil {
		panic(err)
	}
...
func (_q *LabelQuery) WithResource(opts ...func(*ResourceQuery)) *LabelQuery {
	query := (&ResourceClient{config: _q.config}).Query()
...
func (_q *LabelQuery) sqlAll(ctx context.Context, hooks ...queryHook) ([]*Label, error) {
	...
	if query := _q.withResource; query != nil {
		if err := _q.loadResource(ctx, query, nodes, nil,
			func(n *Label, e *Resource) { n.Edges.Resource = e }); err != nil {
			return nil, err
		}
	}
	return nodes, nil
...
func (_q *LabelQuery) loadResource(ctx context.Context, query *ResourceQuery, nodes []*Label, init func(*Label), assign func(*Label, *Resource)) error {
	ids := make([]int, 0, len(nodes))
	nodeids := make(map[int][]*Label)
	for i := range nodes {
		if nodes[i].resource_labels == nil {
			continue
		}
		fk := *nodes[i].resource_labels
	...
	for _, n := range neighbors {
		...
		if !ok {
			return fmt.Errorf(`unexpected foreign-key "resource_labels" returned %v`, n.ID)
		}
		for i := range nodes {
			assign(nodes[i], n)
		}
