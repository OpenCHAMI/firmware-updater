...
//   - /firmwareupdatecampaigns (FirmwareUpdateCampaign operations)
...
func registerResourcePrefixes() error {
	...
	resource.RegisterResourcePrefix("FirmwareUpdateCampaign", "firmwareupdatecampaign")
...
func RegisterGeneratedRoutes(r chi.Router) {
	...
	r.Group(func(protected chi.Router) {
		...
		// FirmwareUpdateCampaign routes
		protected.Route("/firmwareupdatecampaigns", func(r chi.Router) {
