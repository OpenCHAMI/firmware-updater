...
//   - /firmwarebundles (FirmwareBundle operations)
...
func registerResourcePrefixes() error {
	...
	resource.RegisterResourcePrefix("FirmwareBundle", "firmwarebundle")
...
func RegisterGeneratedRoutes(r chi.Router) {
	...
	r.Group(func(protected chi.Router) {
		...
		// FirmwareBundle routes
		protected.Route("/firmwarebundles", func(r chi.Router) {
			r.Get("/", GetFirmwareBundles)
			r.Post("/", CreateFirmwareBundle)
			r.Route("/{uid}", func(r chi.Router) {
				r.Get("/", GetFirmwareBundle)
				r.Put("/", UpdateFirmwareBundle)
				r.Patch("/", PatchFirmwareBundle)
				r.Delete("/", DeleteFirmwareBundle)

				// Status subresource
				r.Route("/status", func(r chi.Router) {
					r.Put("/", UpdateFirmwareBundleStatus)
					r.Patch("/", PatchFirmwareBundleStatus)
				})
			})
		})
