...
func runServer(cmd *cobra.Command, args []string) error {
	...
	if config.ReconcileEnabled {
		ctx := context.Background()
		firmwareResolver := firmwareproxy.NewResolver(config.RegistryDomain, config.RegistryUsername, config.RegistryPassword)
		reconcilers.SetFirmwareProxyResolver(firmwareResolver)
	...
	registerFirmwareProxyRoute(r, firmwareproxy.NewResolver(config.RegistryDomain, config.RegistryUsername, config.RegistryPassword))
