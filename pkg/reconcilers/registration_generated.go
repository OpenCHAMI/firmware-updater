...
func RegisterReconcilers(controller *reconcile.Controller, client reconcile.ClientInterface, eventBus events.EventBus) error {
	// Register FirmwareBundle reconciler
	firmwarebundlesReconciler := NewDefaultFirmwareBundleReconciler(client, eventBus)
	if err := controller.RegisterReconciler(firmwarebundlesReconciler); err != nil {
		return err
	}
